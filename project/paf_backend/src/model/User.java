...
public class User {
	...
	public String updateUser(String ID, String name, String NIC, String phoneNo, String email) {
		...
		try {
			...
			prStmt.setString(2, NIC);
			prStmt.setString(3, phoneNo);
			prStmt.setString(4, email);
			prStmt.setInt(5, Integer.parseInt(ID));
